...
import com.example.travelbud.databinding.ActivityPlannedBinding
...
class planned : AppCompatActivity(), OnMapReadyCallback {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.book.setOnClickListener {
            val intent = Intent(this@planned, booked::class.java)
